const featureCardsInfo = [
  ...
  },
  {
    ...
    description:
      "We offer Innovative STEAM (Science, Technology, Engineering, Arts, and Mathematical) programs that promote hands-on exploration, critical thinking, and problem-solving skills.",
  },
  {
    img: {
...
const bText = "Our Features";
const hText = "Our Special Features";
const pText =
...
export { featureCardsInfo, bText, hText, pText };
